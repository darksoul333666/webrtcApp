...
import { KeysPaypal } from '../../../../utils/cache/Credentianls';
const PaypalScreen = () => {
  return<></>
  // Set token here to not have to paste every time (make sure not to commit!)
  // const [token, setToken] = useState(KeysPaypal.KEY);
  ...
  //   requestOneTimePayment('sandbox_8hp54yn6_d2q58xkcprrz6d46', {amount})
  //     .then(setSuccess)
  //     .then(() => setError2a(''))
